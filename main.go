...
func main() {
	if len(os.Args) < 2 { print_usage(); return }
	switch os.Args[1] {
	...
	case "save":
		switch len(os.Args) {
		case 2: gc_save("")
		case 3: gc_save(os.Args[2])
		default: print_usage(); return
		}
	case "log":
		switch len(os.Args) {
		case 3: gc_log(os.Args[2])
		default: print_usage(); return
		}
	case "config":
		switch len(os.Args) {
		...
		case 4:
			switch os.Args[2] {
			case "-n": gc_config(os.Args[3], "")
			case "-e": gc_config("", os.Args[3])
			default: print_usage(); return
			}
		case 6:
			name_arg, email_arg := "", ""
			switch os.Args[2] {
			case "-n": name_arg = os.Args[3]
			case "-e": email_arg = os.Args[3]
			default: print_usage(); return
			}
			switch os.Args[4] {
			case "-n": name_arg = os.Args[5]
			case "-e": email_arg = os.Args[5]
			default: print_usage(); return
			}
	...
	// TODO:
	case "clone": fmt.Printf("TODO: clone\n")
	case "push": fmt.Printf("TODO: push\n")
	case "pull": fmt.Printf("TODO: pull\n")
	case "remote":
		switch len(os.Args) {
		case 2: fmt.Printf("TODO: remote get\n")
		case 3: fmt.Printf("TODO: remote set %v\n", os.Args[2])
		default: print_usage(); return
		}
	case "export": fmt.Printf("TODO: export\n")
	default: print_usage(); return
	}
}
